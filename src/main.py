...
if __name__ == "__main__":
    ...
    # for i in range(1,6):
    #      test_optimized_angles(rp=rp, start_n=500, end_n=2001, step=500, fun=generate_scale_free, scaling_values=[2, 2.25, 2.50, 2.75, 3], k_min=i, strictlyEnforceMinimumDegree=True, index=i)
    ...
    run_example_scale_free(fun=generate_scale_free, n=500, g=2.5, k_min=2)
